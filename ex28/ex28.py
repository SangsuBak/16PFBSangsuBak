# -*- coding: utf8 -*-
# http://eclass.kpu.ac.kr/ilos/st/course/lecture_material_view_form.acl?ARTL_NUM=350622&SCH_KEY=&SCH_VALUE=&display=10&start=1

print " 1. True and True = %s" % str(True and Ture)
print " 2. False and Ture = %s" % str(False and Ture)
...
print " 8. True or 1==1 = %s" % True or (l ==1)
print " 9. 'test' == 'testing' = %s" % str('test' == 'testiing')
...
print "extra 2. 1 and 1 = = %s" % str(1and1))
